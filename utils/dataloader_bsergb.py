...
class BSERGB_train_dataset(data.Dataset):
    ...
    def get_filetaxnomy(self, data_dir):
        ...
        self.input_name_dict['clean_image_second'] = []
        ...
        for triplet in triplets:
            ...
            for interp_idx in range(1, unit_frame - 1):
                ...
                self.input_name_dict['clean_image_second'].append(os.path.join(clean_image_dir, str(second_idx).zfill(6) + '.png'))
    ...
    def __getitem__(self, index):
        ...
        # second image
        second_image_path = self.input_name_dict['clean_image_second'][index]
        ...
        ## return sample!!
        sample = dict()
        sample['clean_gt_image'] = gt_image_tensor
        sample['clean_first_image'] = first_image_tensor
        sample['clean_second_image'] = second_image_tensor
    ...
    def __len__(self):
        return len(self.input_dict['gt_image'])



def get_train_dataset(data_dir, skip_list, mode='3_TRAINING'):
    dataset_list = []
...
if __name__ == '__main__':
    ...
    skip_list = [3, 1]
    get_train_dataset(dataset_dir, skip_list)